...
pub fn Footer() -> impl IntoView {
    view! {
        ...
        <footer class="relative border-t border-honey/10 bg-surface/55 backdrop-blur-md">
            <div aria-hidden="true" class="absolute bottom-full inset-x-0 pointer-events-none select-none text-center font-black text-honey/15 leading-[0.85] tracking-tight text-[clamp(4rem,18vw,14rem)] overflow-hidden">
                "commitbee"
            </div>
